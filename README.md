...
using real clinical data to build models that could actually be useful
— detecting tumours, predicting disease risk, that kind of thing.

Still learning a lot, but I ship things. That's the point.
...
things i've built so far — all in the healthcare/ML space

| project | what it does |
|---------|-------------|
| [Brain Tumour Detection](https://github.com/Hussain07123/Brain-Tumour-Detections-) | detects brain tumours from MRI scans using deep learning |
| [Breast Cancer Assistant API](https://github.com/Hussain07123/Breast-Cancer-Assistant-API-) | REST API for breast cancer diagnosis assistance |
...
currently figuring out how to make models that don't just work on
kaggle datasets. if you're into healthcare AI or just want to talk
